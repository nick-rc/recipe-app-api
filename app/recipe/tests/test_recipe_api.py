...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipes(self):
        """Test retrieving a est of recipes"""
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, name='Vodka')
    ...
    def test_partial_recipe_update(self):
        """Test updating part of recipe (PATCH)"""
    ...
    def test_full_recipe_update(self):
        """Test updatings a recipe with put"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        payload = {
            'title': 'Carbonara',
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tag(self):
        ...
        recipe1 = sample_recipe(user=self.user, title="TVC")
        recipe2 = sample_recipe(user=self.user, title="Tahiti")
        tag1 = sample_tag(user=self.user, name='Vegan')
        tag2 = sample_tag(user=self.user, name='Not Vegan')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title="Chimken")
    ...
    def test_filter_recipes_by_ingredient(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, name='Not Milk')
